# -*- coding: utf-8 -*-
"""
Created on Sat Feb 26 16:11:21 2022
...
def parse_args():
    ...
    parser.add_argument('--env', type=str, required=False, default='catchup', help="environment(eight/ring/catchup/slowdown/UAV_Nav/Car/UAV_2/UAV_101)")
