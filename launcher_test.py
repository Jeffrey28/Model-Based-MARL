# -*- coding: utf-8 -*-
"""
Created on Mon Jan 24 01:15:49 2022
...
from algorithms.envs.UAV_test import UAV_Env
from algorithms.envs.UAV_2_test import UAV_2_Env
from algorithms.envs.UAV_101_test import UAV_101_Env
from algorithms.envs.Car import Car_Env
from algorithms.mbdppo.MB_DPPO_test import OnPolicyRunner
...
def parse_args():
    ...
    parser.add_argument('--env', type=str, required=False, default='UAV_101', help="environment(eight/ring/catchup/slowdown/UAV_Nav/Car/UAV_2/UAV_101)")
...
if input_args.algo == 'IA2C':
    from algorithms.mbdppo.MB_DPPO_test import IA2C as agent_fn
elif input_args.algo == 'IC3Net':
    from algorithms.mbdppo.MB_DPPO_test import IC3Net as agent_fn
elif input_args.algo in ['CPPO', 'DPPO']:
    from algorithms.mbdppo.MB_DPPO_test import DPPOAgent as agent_fn
elif input_args.algo in ['DMPO']:
    from algorithms.mbdppo.MB_DPPO_test import MB_DPPOAgent as agent_fn
...
if run_args.profiling:
    ...
    OnPolicyRunner(logger = logger, run_args=run_args, alg_args=alg_args, agent=agent, env_learn=env_train, env_test = env_test).test()
