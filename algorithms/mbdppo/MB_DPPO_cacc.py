# -*- coding: utf-8 -*-
"""
Created on Sat Feb 26 16:13:08 2022
...
# 绘制静态轨迹------------------------------------------------------------------------------------------------------    
            ...
            if i+1 == self.n_test:                
                ...
                for j in range(self.n_agent):  
                    ...
                    # if j == 2:
                    #     plt.plot(Step,dp(v_)[j],color='purple',label="vehicle 3")
                    # if j == 3:
                    #     plt.plot(Step,dp(v_)[j],color='orange',label="vehicle 4")
                    if j == 4:
                        plt.plot(Step,dp(v_)[j],color='green',label="vehicle 5")
                    # if j == 5:
                    #     plt.plot(Step,dp(v_)[j],color='teal',label="vehicle 6")
                    # if j == 6:
                    #     plt.plot(Step,dp(v_)[j],color='peru',label="vehicle 7")
                    if j == 7:
                        plt.plot(Step,dp(v_)[j],color='royalblue',label='vehicle 8')
            ...
            if i+1 == self.n_test:                
                ...
                for j in range(self.n_agent):  
                    ...
                    # if j == 2:
                    #     plt.plot(Step,dp(h_)[j],color='purple',label="vehicle 3")
                    # if j == 3:
                    #     plt.plot(Step,dp(h_)[j],color='orange',label="vehicle 4")
                    if j == 4:
                        plt.plot(Step,dp(h_)[j],color='green',label="vehicle 5")
                    # if j == 5:
                    #     plt.plot(Step,dp(h_)[j],color='teal',label="vehicle 6")
                    # if j == 6:
                    #     plt.plot(Step,dp(h_)[j],color='peru',label="vehicle 7")
                    if j == 7:
                        plt.plot(Step,dp(h_)[j],color='royalblue',label='vehicle 8')
                plt.xlabel('Steps',fontsize=15)
