...
# 绘制静态轨迹------------------------------------------------------------------------------------------------------    
            ...
            if i+1 == self.n_test:                
                ...
                for j in range(self.n_agent):  
                    ...
                    if j == 3:
                        plt.plot(Step,dp(v_)[j],color='fuchsia',label="vehicle 4")
                    if j == 6:
                        plt.plot(Step,dp(v_)[j],color='purple',label="vehicle 7")
                    if j == 9:
                        plt.plot(Step,dp(v_)[j],color='orange',label="vehicle 10")
                    if j == 12:
                        plt.plot(Step,dp(v_)[j],color='green',label="vehicle 13")
                    if j == 15:
            ...
            if i+1 == self.n_test:                
                ...
                for j in range(self.n_agent):  
                    ...
                    if j == 3:
                        plt.plot(Step,dp(pos_)[j],color='fuchsia',label="vehicle 4")
                    if j == 6:
                        plt.plot(Step,dp(pos_)[j],color='purple',label="vehicle 7")
                    if j == 9:
                        plt.plot(Step,dp(pos_)[j],color='orange',label="vehicle 10")
                    if j == 12:
                        plt.plot(Step,dp(pos_)[j],color='green',label="vehicle 13")
                    if j == 15:
